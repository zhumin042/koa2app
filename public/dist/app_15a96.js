...
/******/ 	var hotCurrentHash = "15a96dd31b4754aac225"; // eslint-disable-line no-unused-vars
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__libs_x_tag_x_tag_core__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__libs_x_tag_x_tag_core___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__libs_x_tag_x_tag_core__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__thumb__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__styles_main_css__ = __webpack_require__(4);
...
__WEBPACK_IMPORTED_MODULE_1__libs_x_tag_x_tag_core___default.a.register('x-praise', {
    lifecycle: {
        created: function () {
    ...
    __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.fn.extend({
        "jqThumb": function (options) {
            return this.each(function () {//这里return返回的是 jQuery对象，为了支持链式调用
                var curThis = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this);
...
//创建Jquery插件
creatJqueryPugin(__WEBPACK_IMPORTED_MODULE_2__thumb__["a" /* default */].Thumb);
__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.hand').jqThumb();
...
"use strict";
throw new Error("Cannot find module \"myUnderscore\"");
...
class PraseButton{
	...
	addAction(){
		this.dom.addEventListener('click',
			__WEBPACK_IMPORTED_MODULE_0_myUnderscore___default.a.throttle(
				()=>{
					this.num++;
					let childDom = null;
					if(this.num>10){
